...
function createData(DoctorName, DoctorSpeciality, Date, Status) {
  return { DoctorName, DoctorSpeciality, Date, Status };
}

const rows = [
  createData('Doctor 1', 'Speciality 1', new Date('12/12/2002'), 'completed'),
  createData('Doctor 2', 'Speciality 2', new Date('01/15/2003'), 'pending'),
